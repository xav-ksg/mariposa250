...
// To change the public event start/end time, edit only the constants below.
// All pages, JSON-LD schemas, and visible content import from here.
// (Note: vendor/staff hours start earlier — see keyMoments below.)
// =================================================================
...
export const EVENT_START_TIME_DISPLAY = '11:00 AM';
...
export const faq: FAQItem[] = [
  {
    ...
    answer:
      'Saturday, July 4, 2026, in downtown Mariposa, California. Gates open at 11:00 AM. The event runs until 11:00 PM, including the 200-drone light show at approximately 9:00 PM.',
  },
  {
    category: 'general',
